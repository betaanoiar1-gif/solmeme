...
SOLANA_REAL_SEED_TOKENS: List[TokenSeed] = [
    ...
    TokenSeed(
        ...
        name="Official Trump",
        price=2.33,
        liquidity=18_500_000.0,
        market_cap=2_330_000_000.0,
        volume_24h=95_000_000.0,
        buyers_24h=18_500,
        sellers_24h=16_200,
        holders_count=450_000,
        creator="TrumpMemeOrg1111111111111111111111111111",
        pool_address="TrumpPoolRaydium111111111111111111111111",
        mint_auth_revoked=True,
        freeze_auth_revoked=True,
        lp_locked_pct=100.0,
        ...
        whale_netflow=540_000.0,
        age_minutes=60_000.0
    ),
    TokenSeed(
        mint="2b1kV6DkPAnmd5cvKuTVRkK9wP3X4y6MSo1111111111",
        symbol="PENGU",
        name="Pudgy Penguins",
        price=0.010,
        liquidity=9_500_000.0,
        market_cap=899_000_000.0,
        volume_24h=32_000_000.0,
        buyers_24h=7_200,
        sellers_24h=5_900,
        holders_count=120_000,
        creator="PenguDeployer1111111111111111111111111111",
        pool_address="PenguPoolRaydium1111111111111111111111111",
        mint_auth_revoked=True,
        freeze_auth_revoked=True,
        lp_locked_pct=100.0,
        top10_holder_pct=21.5,
        dev_holding_pct=1.5,
        narrative="Brand / Community",
        smart_money_score=80.0,
        whale_netflow=290_000.0,
